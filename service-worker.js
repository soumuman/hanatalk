const CACHE='talk-flower-v3';
const ASSETS=['./','./index.html','./css/style.css','./js/app.js','./js/db.js','./js/calendar.js','./js/people.js','./js/flower.js','./js/comments.js','./js/sound.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
