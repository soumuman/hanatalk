const CACHE='talk-flower-release-008';
const ASSETS=['./','./index.html','./css/style.css','./js/app.js','./js/drag-order.js','./js/version.js','./js/updates.js','./js/db.js','./js/calendar.js','./js/seasons.js','./js/people.js','./js/flower.js','./js/comments.js','./js/sound.js','./manifest.json','./icons/icon-192.png','./icons/icon-512.png'];
