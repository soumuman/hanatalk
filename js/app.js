...
function onboarding(){app.innerHTML=`<section class="welcome"><div class="welcome-option"><h1>はじめて使う方</h1><p>話した相手を記録して、日々の花を育てます。</p><a class="welcome-button" href="#register">人物を登録してはじめる</a><p class="small">ログインせず、この端末だけでも使えます。</p></div><div class="welcome-option"><h1>すでに利用している方</h1><p>ホーム画面から初めて起動した場合は、もう一度ログインが必要です。</p><button class="welcome-button" data-restore-login>ログインして記録を引き継ぐ</button><p class="small">ログインすると、これまでの人物・会話記録をクラウドから読み込みます。</p></div></section>`;}
function calendar(){
